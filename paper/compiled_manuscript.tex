...
As of May 4, 2026, the Norwegian Continental Shelf (NCS) faces an
unprecedented dual challenge: maintaining its role as the primary
guarantor of European energy security while adhering to the stringent
emission reduction targets of the ``Fit For 55'' mandate.
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Pareto Trade-off: Production vs Emissions}]{../scatter_tradeoff.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Production Phase-out Scenarios}]{../production_scenarios.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Annual Emission Intensity}]{../annual_intensity.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Marginal Abatement Cost Curve}]{../mac_curve.png}}
...
hubs---such as the massive Yggdrasil development (where the 2025 ``Omega
Alfa'' campaign recently discovered an additional 96-134 million barrels
of oil equivalent)---is the most efficient way to maintain output while
slash emissions.
